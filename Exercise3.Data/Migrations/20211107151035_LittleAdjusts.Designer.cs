...
namespace Exercise3.Data.Migrations
{
    ...
    [Migration("20211107151035_LittleAdjusts")]
    partial class LittleAdjusts
    {
            ...
            modelBuilder.Entity("Exercise3.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Adress = "",
                            BirthDate = new DateTime(2021, 11, 7, 10, 10, 33, 813, DateTimeKind.Local).AddTicks(318),
                            FirstName = "Teacher",
                            LastName = "1",
                            Sex = "F"
                        },
                        new
                        {
                            Id = 2,
                            Adress = "",
                            BirthDate = new DateTime(2021, 11, 7, 10, 10, 33, 819, DateTimeKind.Local).AddTicks(9940),
                            FirstName = "Teacher",
                            LastName = "2",
                            Sex = "M"
                        });
